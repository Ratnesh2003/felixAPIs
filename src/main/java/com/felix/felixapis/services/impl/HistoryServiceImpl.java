...
public class HistoryServiceImpl implements HistoryService {
    ...
    public HistoryServiceImpl(WatchedHistoryRepository watchedHistoryRepository, GetDetailsFromUser getDetailsFromUser, MoviesRepository moviesRepository, ImageIDFromMovie imageIDFromMovie) {
