...
public class ReviewServiceImpl implements ReviewService {
    ...
    public ReviewServiceImpl(GetDetailsFromUser getDetailsFromUser, ReviewRepository reviewRepository, UserRepository userRepository, MoviesRepository moviesRepository) {
